...
\newenvironment{biblechapter}[1][\thebiblechapter]
  {\biblechap@svdopt=#1
    ...
    \lettrine[lines=3,lhang=0,findent=0pt,nindent=0pt,loversize=0.25]%
      {\lettrinefont\color{\chapnumcolor}\,\thebiblechapter\,}{}%
      \ignorespaces}
...
\newcommand{\@showversenum}{%
  ...
  \markboth{{\scshape\currbook} \thebiblechapter:\thebibleverse}%
    {{\scshape\currbook} \thebiblechapter:\thebibleverse}%
  \ignorespaces}
...
\newcount\currversepart@svdopt
\newenvironment{partedverse}[1][1]
  {\currversepart@svdopt=#1
    \setcounter{verseparted}{\the\currversepart@svdopt}}
  {}
\newcommand{\versepartalph}{%
  {\color{\versenumcolor}\textbf{\thebibleverse\alph{verseparted}}}%
  \markboth{{\scshape\currbook} \thebiblechapter:\thebibleverse\alph{verseparted}}
    {{\scshape\currbook} \thebiblechapter:\thebibleverse\alph{verseparted}}%
  \ignorespaces}
\newcommand{\versepart}{\versepartalph~\stepcounter{verseparted}}
\newcommand{\versepartWithSubheading}[1]{%
  \ifnum\c@bibleverse=1{\subsectionstyle#1\newline}\else\subsection*{#1}\fi\versepartalph%
  \stepcounter{verseparted}}
...
\startornaments
\input{kejadian.tex}\flushcolsend
